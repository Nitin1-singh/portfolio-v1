...
export default function Code2({line,code,code1,codeColor,code1Color,code2,code2Color,code3,code4,code3Color,code4Color,padding}) {
    return (
        <div className={`container-fluid row justify-content-center align-items-center ${about.lightHover}`}>
            ...
            <div className={`col-md-10 col-10  ${about.bd}`}>
                <div className={`ps-4`}>
                    ...
                    <span style={{color:code1Color}} className={`${about.code}`}>{code1}</span>
                    <span style={{color:code2Color}} className={`${about.code}`}>{code2}</span>
                    <span style={{color:code3Color}} className={`${about.code} px-2`}>{code3}</span>
                    <span style={{color:code4Color}} className={`${about.code}  ${about.codeRes} mb-5`}>{code4}</span>
                </div>
            </div>
        </div>
    )
